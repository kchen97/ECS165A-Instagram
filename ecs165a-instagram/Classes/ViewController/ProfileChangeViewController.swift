...
class ProfileChangeViewController: InputViewController {
    ...
    override func setup() {
        ...
        tableview.register(ProfilePictureTableViewCell.self, forCellReuseIdentifier: InputType.button.rawValue)
    }
